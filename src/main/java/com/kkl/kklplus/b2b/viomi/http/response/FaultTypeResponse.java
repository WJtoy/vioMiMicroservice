 ...
 */
@ToString
public class FaultTypeResponse implements Serializable {
    ...
    @Getter
    @Setter
    private List<com.kkl.kklplus.entity.viomi.sd.FaultType> data;

    public FaultTypeResponse() {
    }

    public FaultTypeResponse(ResponseBody.ErrorCode errorCode) {
        this(errorCode, null);
    }

    public FaultTypeResponse(ResponseBody.ErrorCode errorCode, Exception exception) {

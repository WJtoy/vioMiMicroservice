...
public class ProductResponse {
    ...
    @Getter
    @Setter
    private List<ProductParts> data;

    public ProductResponse() {
    }

    public ProductResponse(ResponseBody.ErrorCode errorCode) {
        this(errorCode, null);
    }

    public ProductResponse(ResponseBody.ErrorCode errorCode, Exception exception) {
